...
import com.mssng.android.AddMissingPersonInfoActivity;
import com.mssng.android.R;
import com.mssng.android.Utils;
import com.squareup.picasso.Callback;
import com.squareup.picasso.Picasso;
...
public class UserProfileAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void bindPhoto(final PhotoViewHolder holder, int position) {
        ...
        holder.ivPhoto.setOnClickListener(new DebouncingOnClickListener() {
            @Override
            public void doClick(View v) {
                Intent addMissingIntent = new Intent(context, AddMissingPersonInfoActivity.class);
                addMissingIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                context.startActivity(addMissingIntent);
